/**
 * Ficha de convocatoria de Oficial Herrero (Ayto. Zaragoza).
 *
 ...
 * - Base 1.4 (líneas 55-56): 5 plazas (4 TLO, 1 TLO-D), Escala de
 *   Administración Especial, OEP/25/26.
 * - Base 1.8 (línea 214): Oficial Herrero SÍ figura en la lista de
 ...
 * - Base 2.2.1.5 (líneas 288-291): además de Graduado/a en ESO, exige
 *   certificado de profesionalidad de la familia profesional
 *   Fabricación mecánica de nivel 1 o superior, o certificado de
 *   profesionalidad de la familia Fabricación mecánica.
 * - Base 5.1 (línea 412): 130 aspirantes máximo pasan al segundo
 *   ejercicio (130 TLO).
 * - Base 5.2 (línea 434): 15 aspirantes máximo pasan a la prueba
 *   adicional práctica (15 TLO).
 ...
 *
 * Uso: node --env-file=.env.local scripts/seed-convocatoria-oficial-herrero.mjs
 */
  ...
  [
    {
      ...
      plaza: "Oficial Herrero — Escala de Administración Especial, Subescala de Servicios Especiales, Clase Personal de Oficios (Grupo C, Subgrupo C2)",
      ...
      requisito_titulacion:
        "Graduada/o en Educación Secundaria Obligatoria (ESO), o titulación equivalente a efectos profesionales. Además, certificado de profesionalidad de la familia profesional Fabricación mecánica de nivel 1 o superior, o certificado de profesionalidad de la familia Fabricación mecánica. El certificado de profesionalidad debe poseerse en la fecha de realización del primer ejercicio.",
      ...
      desglose_plazas: [
        ...
        { turno: "Turno libre de reserva para personas con discapacidad (TLO-D)", cantidad: 1 },
      ],
      aspirantes_que_pasan_fase: [
        {
          fase: "Superan el primer ejercicio (test teórico) y pasan al segundo ejercicio",
          cantidad: "130 personas aspirantes (turno libre ordinario)",
        },
        {
          fase: "Superan el segundo ejercicio y pasan a la prueba adicional práctica",
          cantidad: "15 personas aspirantes (turno libre ordinario)",
        },
      ],
      enlaces_oficiales: [
        {
      ...
      pruebas: [
        {
          ...
          detalle:
            "Preguntas tipo test sobre los 22 temas del temario oficial (parte primera común + parte segunda de herrero). Calificación de 0 a 10 puntos; mínimo 5 para superarlo. Cada error resta 1/4 del valor de un acierto; las no contestadas no penalizan.",
        },
        {
        ...
        },
        {
          id: "prueba-adicional",
          numero: 3,
          nombre: "Prueba adicional práctica de herrería",
          icono: "🔨",
          ...
          opciones: "Solo la realizan quienes superan los dos ejercicios anteriores (máx. 15 aspirantes)",
          detalle:
...
console.log("\n✅ Convocatoria de Oficial Herrero sembrada.");
