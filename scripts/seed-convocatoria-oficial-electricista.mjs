/**
 * Ficha de convocatoria de Oficial Electricista (Ayto. Zaragoza).
 *
 ...
 * Agente Inspector, Oficial Carpintero, Oficial Cementerio).
 *
 * Fuentes primarias, leídas íntegras en esta sesión sobre
 * scripts/tmp-fuentes/bases2110.txt:
 * - Base 1.4 (líneas 57-58): 4 plazas (4 TLO), Escala de Administración
 *   Especial, OEP/24/25/26.
 * - Base 1.8 (línea 215): Oficial Electricista SÍ figura en la lista de
 ...
 * - Base 2.2.1.6 (líneas 293-298): además de Graduado/a en ESO, exige
 ...
 *   familia de Energía y agua, de Electricidad y electrónica, o de
 *   Edificación y obra civil.
 * - Base 5.1 (línea 413): 116 aspirantes máximo pasan al segundo
 *   ejercicio (116 TLO).
 * - Base 5.2 (línea 435): 13 aspirantes máximo pasan a la prueba
 ...
 *
 * Uso: node --env-file=.env.local scripts/seed-convocatoria-oficial-electricista.mjs
 */
  ...
  [
    {
      ...
      plaza: "Oficial Electricista — Escala de Administración Especial, Subescala de Servicios Especiales, Clase Personal de Oficios (Grupo C, Subgrupo C2)",
      fecha_decreto: "15 de julio de 2026",
      sistema_seleccion: "Oposición, turno libre ordinario",
      requisito_titulacion:
        "Graduada/o en Educación Secundaria Obligatoria (ESO), o titulación equivalente a efectos profesionales. Además, certificado de profesionalidad de la familia profesional Electricidad y electrónica de nivel 1 o superior, o certificado de profesionalidad de la familia profesional Energía y agua de nivel 1 o superior, o formación profesional de la familia de Energía y agua, de Electricidad y electrónica, o de Edificación y obra civil. El certificado de profesionalidad debe poseerse en la fecha de realización del primer ejercicio.",
      ...
      plazas_total: 4,
      desglose_plazas: [
        { turno: "Turno libre ordinario (TLO)", cantidad: 4 },
      ],
      ...
      pruebas: [
        {
          ...
          detalle:
            "Preguntas tipo test sobre los 22 temas del temario oficial (parte primera común + parte segunda de electricista). Calificación de 0 a 10 puntos; mínimo 5 para superarlo. Cada error resta 1/4 del valor de un acierto; las no contestadas no penalizan.",
        },
        {
        ...
        },
        {
          id: "prueba-adicional",
          numero: 3,
          nombre: "Prueba adicional práctica de electricidad",
          icono: "⚡",
...
console.log("\n✅ Convocatoria de Oficial Electricista sembrada.");
