/**
 * Ficha de convocatoria de Oficial Pintor, Especialidad General (Ayto.
 * Zaragoza).
 *
 ...
 * - Base 1.8 (línea 213): Oficial Pintor Especialidad General SÍ figura
 ...
 *   — su proceso consta de TRES pruebas.
 * - Base 2.2.1.9 (líneas 313-314): además de Graduado/a en ESO, exige
 *   certificado de profesionalidad de la familia profesional
 *   Edificación y obra civil, Albañilería y acabados, Pintura
 *   industrial/pintura decorativa de nivel 2.
 * - Base 5.1 (línea 411): 63 aspirantes máximo pasan al segundo
 *   ejercicio (dentro del bloque conjunto de 126 de "Oficial Pintor"
 *   repartido a partes iguales entre sus dos especialidades).
 * - Base 5.2 (línea 438-439): 7 aspirantes máximo pasan a la prueba
 *   adicional práctica.
 ...
 *
 * Uso: node --env-file=.env.local scripts/seed-convocatoria-oficial-pintor-general.mjs
 */
  ...
  [
    {
      ...
      plaza: "Oficial Pintor, Especialidad General — Escala de Administración Especial, Subescala de Servicios Especiales, Clase Personal de Oficios (Grupo C, Subgrupo C2)",
      fecha_decreto: "15 de julio de 2026",
      sistema_seleccion: "Oposición, turno libre ordinario (TLO)",
      requisito_titulacion:
        "Graduada/o en Educación Secundaria Obligatoria (ESO), o titulación equivalente a efectos profesionales. Además, certificado de profesionalidad de la familia profesional de Edificación y obra civil, Albañilería y acabados, Pintura industrial/pintura decorativa de nivel 2. Este certificado debe poseerse en la fecha de realización del primer ejercicio.",
      ...
      pruebas: [
        {
          ...
          detalle:
            "Preguntas tipo test sobre los 22 temas del temario oficial (parte primera común + parte segunda de pintor, especialidad general). Calificación de 0 a 10 puntos; mínimo 5 para superarlo. Cada error resta 1/4 del valor de un acierto; las no contestadas no penalizan.",
        },
        {
        ...
        },
        {
          id: "prueba-adicional",
          numero: 3,
          nombre: "Prueba adicional práctica de pintura",
          icono: "🎨",
...
console.log("\n✅ Convocatoria de Oficial Pintor General sembrada.");
