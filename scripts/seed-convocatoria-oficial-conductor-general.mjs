/**
 * Ficha de convocatoria de Oficial Conductor, Especialidad General
 * (Ayto. Zaragoza).
 *
 ...
 * X", incluida su hermana Oficial Conductor Maquinaria Pesada).
 *
 * Fuentes primarias, leídas íntegras en esta sesión sobre
 * scratch_bases/bases2110.txt:
 * - Base 1.8 (línea 220): Oficial Conductor Especialidad General SÍ
 *   figura en la lista de plazas/categorías que deben realizar además
 *   la prueba adicional práctica de la base 7.4.D de las bases
 *   generales — su proceso consta de TRES pruebas.
 * - Base 2.2.1.11 (líneas 327-330): exige, además de Graduado/a en ESO,
 *   estar en posesión del permiso de conducción clase «C» y «E», así
 *   como certificado de aptitud profesional (CAP), requisitos que deben
 *   poseerse en la fecha de realización del primer ejercicio.
 * - Base 5.1 (línea 419-420): 160 aspirantes máximo pasan al segundo
 *   ejercicio en el bloque conjunto de "Oficial Conductor" (160 TLO),
 *   repartidos a partes iguales entre sus dos especialidades: 80 para
 *   Especialidad General.
 * - Base 5.2 (línea 446-447): del bloque conjunto de 18 aspirantes que
 *   pasan a la prueba adicional práctica, 9 corresponden a Especialidad
 *   General.
 * - Plazas: 2 (2 TLO) — dato ya compilado en
 *   scripts/seed-oficial-x-parte-comun.mjs a partir de la base 1.4 y
 *   confirmado en el Anexo Plazas (códigos 541500048 y 541500065).
 ...
 *
 * Uso: node --env-file=.env.local scripts/seed-convocatoria-oficial-conductor-general.mjs
 */
  ...
  [
    {
      ...
      plaza: "Oficial Conductor, Especialidad General — Escala de Administración Especial, Subescala de Servicios Especiales, Clase Personal de Oficios (Grupo C, Subgrupo C2)",
      ...
      pruebas: [
        {
          ...
          detalle:
            "Preguntas tipo test sobre los 22 temas del temario oficial (parte primera común + parte segunda de conductor, especialidad general). Calificación de 0 a 10 puntos; mínimo 5 para superarlo. Cada error resta 1/4 del valor de un acierto; las no contestadas no penalizan.",
        },
        {
        ...
        },
        {
          id: "prueba-adicional",
          numero: 3,
          nombre: "Prueba adicional práctica de conducción",
          icono: "🚐",
...
console.log("\n✅ Convocatoria de Oficial Conductor General sembrada.");
