/**
 * Ficha de convocatoria de Oficial Guardallaves (Ayto. Zaragoza).
 *
 ...
 * Electricista, Oficial Herrero, Oficial Mecánico).
 *
 * Fuentes primarias, leídas íntegras en esta sesión sobre
 * scripts/tmp-fuentes... / scratch_bases/bases2110.txt (descarga y
 * conversión a texto de https://www.zaragoza.es/cont/paginas/oferta/
 * archivos/bases/bases2110.pdf en esta misma sesión):
 * - Base 1.4 (línea 112): 9 plazas (5 TLO, 1 TLO (A) —ampliación—, 2
 *   TLO (D) —reserva discapacidad—, 1 TLRDIS —reserva discapacidad
 *   física, sensorial u otra—), Escala de Administración Especial,
 *   OEP/25/26.
 * - Base 1.8 (línea 210): Oficial Guardallaves SÍ figura en la lista de
 ...
 * - Base 2.2.1.1 (líneas 261-265): además de Graduado/a en ESO, exige
 *   estar en posesión del certificado de profesionalidad de la familia
 *   profesional de Energía y agua, o formación profesional de la
 *   familia profesional de Energía y agua, de Edificación y obra civil,
 *   o de Instalación y mantenimiento, poseído en la fecha de
 *   realización del primer ejercicio.
 * - Base 5.1 (línea 403): 198 aspirantes máximo pasan al segundo
 *   ejercicio (176 TLO y 22 TLRDIS).
 * - Base 5.2 (línea 430): 22 aspirantes máximo pasan a la prueba
 *   adicional práctica (20 TLO y 2 TLRDIS).
 ...
 *
 * Uso: node --env-file=.env.local scripts/seed-convocatoria-oficial-guardallaves.mjs
 */
  ...
  [
    {
      ...
      plaza: "Oficial Guardallaves — Escala de Administración Especial, Subescala de Servicios Especiales, Clase Personal de Oficios (Grupo C, Subgrupo C2)",
      fecha_decreto: "15 de julio de 2026",
      sistema_seleccion: "Oposición, turno libre ordinario, turno libre ordinario de ampliación y turno libre de reserva para personas con discapacidad",
      requisito_titulacion:
        "Graduada/o en Educación Secundaria Obligatoria (ESO), o titulación equivalente a efectos profesionales. Además, estar en posesión del certificado de profesionalidad de la familia profesional de Energía y agua, o de formación profesional de la familia profesional de Energía y agua, de Edificación y obra civil, o de Instalación y mantenimiento. Este certificado o titulación debe poseerse en la fecha de realización del primer ejercicio.",
      ...
      plazas_total: 9,
      desglose_plazas: [
        { turno: "Turno libre ordinario (TLO)", cantidad: 5 },
        { turno: "Turno libre ordinario — ampliación (TLO-A)", cantidad: 1 },
        { turno: "Turno libre de reserva para personas con discapacidad (TLO-D)", cantidad: 2 },
        { turno: "Reserva discapacidad física, sensorial u otra (TLRDIS)", cantidad: 1 },
      ],
      aspirantes_que_pasan_fase: [
        {
          fase: "Superan el primer ejercicio (test teórico) y pasan al segundo ejercicio",
          cantidad: "198 personas aspirantes (176 turno libre ordinario y 22 reserva discapacidad física, sensorial u otra)",
        },
        {
          fase: "Superan el segundo ejercicio y pasan a la prueba adicional práctica",
          cantidad: "22 personas aspirantes (20 turno libre ordinario y 2 reserva discapacidad física, sensorial u otra)",
        },
      ],
      enlaces_oficiales: [
        {
      ...
      pruebas: [
        {
          ...
          detalle:
            "Preguntas tipo test sobre los 22 temas del temario oficial (parte primera común + parte segunda de guardallaves). Calificación de 0 a 10 puntos; mínimo 5 para superarlo. Cada error resta 1/4 del valor de un acierto; las no contestadas no penalizan.",
        },
        {
        ...
        },
        {
          id: "prueba-adicional",
          numero: 3,
          nombre: "Prueba adicional práctica de guardallaves",
          icono: "🔧",
          ...
          opciones: "Solo la realizan quienes superan los dos ejercicios anteriores (máx. 22 aspirantes)",
          detalle:
...
console.log("\n✅ Convocatoria de Oficial Guardallaves sembrada.");
