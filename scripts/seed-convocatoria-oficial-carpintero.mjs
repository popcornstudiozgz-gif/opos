/**
 * Ficha de convocatoria de Oficial Carpintero (Ayto. Zaragoza).
 *
 ...
 * - Base 1.4 (líneas 61-62 y 138-139): 2 plazas (1 TLO y 1 TLO (D) —
 *   turno libre ordinario de reserva para personas con discapacidad).
 * - Base 1.8 (líneas 205-221): Oficial Carpintero SÍ figura en la lista
 *   de plazas/categorías que deben realizar además la prueba adicional
 *   práctica de la base 7.4.D de las bases generales (a diferencia de
 *   Oficial Mantenimiento General y Oficial Agente Inspector) — su
 *   proceso consta de TRES pruebas, igual que Instalaciones Deportivas.
 * - Base 2.2.1.8 (líneas 307-309): además de Graduado/a en ESO, exige
 *   certificado de profesionalidad de la familia profesional Madera,
 *   mueble y corcho de nivel 1 o superior, o formación profesional de
 *   esa misma familia, o de la familia profesional Edificación y obra
 *   civil.
 * - Base 5.1 (línea 415): 80 aspirantes máximo pasan al segundo
 *   ejercicio (80 TLO — al ser solo 2 plazas y ambas turno libre, no
 *   hay desglose por tipo de reserva distinto al TLO general).
 * - Base 5.2 (línea 437): 9 aspirantes máximo pasan a la prueba
 ...
 *
 * Uso: node --env-file=.env.local scripts/seed-convocatoria-oficial-carpintero.mjs
 */
  ...
  [
    {
      ...
      plaza: "Oficial Carpintero — Escala de Administración Especial, Subescala de Servicios Especiales, Clase Personal de Oficios (Grupo C, Subgrupo C2)",
      fecha_decreto: "15 de julio de 2026",
      sistema_seleccion: "Oposición, turno libre ordinario y turno libre de reserva para personas discapacitadas (TLO-D)",
      requisito_titulacion:
        "Graduada/o en Educación Secundaria Obligatoria (ESO), o titulación equivalente a efectos profesionales. Además, certificado de profesionalidad de la familia profesional de Madera, mueble y corcho de nivel 1 o superior, o formación profesional de esa misma familia, o de la familia profesional de Edificación y obra civil.",
      ...
      desglose_plazas: [
        ...
        { turno: "Turno libre ordinario de reserva para personas con discapacidad (TLO-D)", cantidad: 1 },
      ],
      ...
      pruebas: [
        {
          ...
          detalle:
            "Preguntas tipo test sobre los 20 temas del temario oficial (parte primera común + parte segunda de carpintería). Calificación de 0 a 10 puntos; mínimo 5 para superarlo. Cada error resta 1/4 del valor de un acierto; las no contestadas no penalizan.",
        },
        {
        ...
        },
        {
          id: "prueba-adicional",
          numero: 3,
          nombre: "Prueba adicional práctica de carpintería",
          icono: "🪚",
...
console.log("\n✅ Convocatoria de Oficial Carpintero sembrada.");
