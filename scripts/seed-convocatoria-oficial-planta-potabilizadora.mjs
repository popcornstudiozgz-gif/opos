/**
 * Ficha de convocatoria de Oficial Planta Potabilizadora (Ayto.
 * Zaragoza).
 *
 ...
 * Electricista, Oficial Herrero, Oficial Mecánico, Oficial
 * Guardallaves).
 *
 * Fuentes primarias, leídas íntegras en esta sesión sobre
 * scratch_bases/bases2110.txt (descarga y conversión a texto de
 * https://www.zaragoza.es/cont/paginas/oferta/archivos/bases/
 * bases2110.pdf, verificada de nuevo en esta sesión):
 * - Base 1.4 (línea 133): 3 plazas (3 TLO), Escala de Administración
 *   Especial, OEP/25/26.
 * - Base 1.8 (línea 216): Oficial Planta Potabilizadora SÍ figura en la
 *   lista de plazas/categorías que deben realizar además la prueba
 *   adicional práctica de la base 7.4.D de las bases generales — su
 *   proceso consta de TRES pruebas.
 * - Base 2.2.1.7 (líneas 300-304): además de Graduado/a en ESO, exige
 *   certificado de profesionalidad de la familia profesional
 *   Electricidad y electrónica de nivel 1 o superior, o de la familia
 *   Energía y agua de nivel 1 o superior, o formación profesional de la
 *   familia Energía y agua, de Electricidad y electrónica, o de
 *   Edificación y obra civil.
 * - Base 5.1 (línea 414): 96 aspirantes máximo pasan al segundo
 *   ejercicio (96 TLO).
 * - Base 5.2 (línea 436): 11 aspirantes máximo pasan a la prueba
 ...
 *
 * Uso: node --env-file=.env.local scripts/seed-convocatoria-oficial-planta-potabilizadora.mjs
 */
  ...
  [
    {
      ...
      plaza: "Oficial Planta Potabilizadora — Escala de Administración Especial, Subescala de Servicios Especiales, Clase Personal de Oficios (Grupo C, Subgrupo C2)",
      fecha_decreto: "15 de julio de 2026",
      sistema_seleccion: "Oposición, turno libre ordinario",
      requisito_titulacion:
        "Graduada/o en Educación Secundaria Obligatoria (ESO), o titulación equivalente a efectos profesionales. Además, certificado de profesionalidad de la familia profesional de Electricidad y electrónica de nivel 1 o superior, o certificado de profesionalidad de la familia profesional de Energía y agua de nivel 1 o superior, o formación profesional de la familia profesional de Energía y agua, de Electricidad y electrónica, o de Edificación y obra civil. Este certificado o titulación debe poseerse en la fecha de realización del primer ejercicio.",
      ...
      pruebas: [
        {
          ...
          detalle:
            "Preguntas tipo test sobre los 22 temas del temario oficial (parte primera común + parte segunda de planta potabilizadora). Calificación de 0 a 10 puntos; mínimo 5 para superarlo. Cada error resta 1/4 del valor de un acierto; las no contestadas no penalizan.",
        },
        {
        ...
        },
        {
          id: "prueba-adicional",
          numero: 3,
          nombre: "Prueba adicional práctica de planta potabilizadora",
          icono: "🔧",
...
console.log("\n✅ Convocatoria de Oficial Planta Potabilizadora sembrada.");
