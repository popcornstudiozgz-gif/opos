          ...
          {enviado ? (
            <div className="mt-8 flex flex-col items-center gap-3 rounded-lg border border-emerald-100 bg-emerald-50 p-5 text-center">
              ...
              <p className="text-sm font-medium text-emerald-800">
                Si esa dirección está registrada, recibirás un correo con el enlace para
                restablecer tu contraseña. Revisa también tu carpeta de spam.
              </p>
              <Link href="/login" className="mt-2 text-sm font-semibold text-brand-600 transition-colors hover:text-brand-800">
